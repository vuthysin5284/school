...
class Testing_register extends CI_Controller {
	...
	function new_testing_enrollment($param1 = '',$param2 = '',$param3 = ''){
        ...
        $this->load->view('testing_register/modal_new_testing', $page_data);
    }
	...
	*/
	...
	function waiting_register(){
        ...
        $this->load->view('testing_register/waiting_register', $page_data);
	}
	/* testing_result
	 * */
    function testing_result(){
        ...
        $this->load->view('testing_register/testing_result', $page_data);
    }
    /* fee_management
     * */
    function fee_management(){
        ...
        $this->load->view('testing_register/fee_management', $page_data);
    }
   ...
   function testing_register(){
    ...
    function testing_report($param1='',$param2='',$param3=''){
        ...
        $this->load->view('testing_register/testing_report',$page_data);
    }
	...
	function testing_general(){
        ...
        $this->load->view('testing_register/testing_general', $page_data);
    }
    ...
    function study_record(){
        ...
        $this->load->view('testing_register/study_record', $page_data);
    }
    // relative
    function relative(){
        if ($this->session->userdata('is_login') != 1) {
        ...
        $this->load->view('testing_register/relative', $page_data);
    }
