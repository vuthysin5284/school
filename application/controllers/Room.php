...
class Room extends CI_Controller {
	...
	*/
    function new_classes($param1 = '',$param2 = '',$param3 = '')
    {
        ...
        $obj->room_id = $this->session->userdata("branch_id");
    ...
    public function roomclasses_data(){
        // DB table to use
        $table = 'room where is_delete=0';
        $primaryKey	= "id";
        // indexes
        $columns = array(
            ...
            array( 'db' => 'floor_id',        	'dt'	=> "floor_id",        	'field'	=> 'floor_id' ),
			array( 'db' => 'building_id',       'dt'	=> "building_id",   	'field'	=> 'building_id' ),
