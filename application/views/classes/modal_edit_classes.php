...
<div class="modal-header">
    ...
    <h4 class="modal-title"><?php echo get_phrase('edit_classes');?></h4>
</div>
    ...
    <?php echo form_open(base_url(),array('class' => 'form-horizontal form-groups-bordered',
        ...
        <div class="form-group">
           <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('classes_name');?> <span class="red">*</span></label>
            <div class="col-sm-8">  
                <input type="text" class="form-control" name="branch_name" placeholder="classes name" data-validate="required"
                	data-message-required="<?php echo get_phrase('value_required');?>" autofocus />
            </div>
        </div>  
        
        <div class="form-group">
            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('description of classes');?><span class="red">*</span></label>
            <div class="col-sm-8">  
        ...
        <div class="form-group"> 
                ...
                <button type="submit" class="btn btn-info pull-right" style="margin-right:5px;" 
                	id="submit-button"><?php echo get_phrase('Edit');?></button>  
