...
<div class="modal-header">
    ...
    <h4 class="modal-title"><?php echo get_phrase('create_role');?></h4> 
</div>
...
<div class="panel-body">
    ...
    <?php echo form_open(base_url() . 'user/user_role/create_role', 
				array('class' => 'form-horizontal form-groups-bordered validate ajax-submit',
				'id'=>'frmUser', 'enctype' => 'multipart/form-data'));?>
      
        <div class="form-group">
           <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('roll_name');?> <span class="red">*</span></label>
            <div class="col-sm-8">  
                <input type="text" class="form-control" name="roll_name" placeholder="roll name" data-validate="required" 
