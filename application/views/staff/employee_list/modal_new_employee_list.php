...
<div class="panel-body">
    ...
    <input type="hidden" name="pb_hidden_id" value="<?php echo $employee_list_detail["id"]?>"/>
    ...
    <div class="form-group">
           <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('employee_number');?> <span class="red">*</span>
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="employee_number" name="employee_number" placeholder="employee_number" />
            </div>
    </div>       
            ...
            <div class="col-sm-8">
                <select class="form-control" id="room_id" name="room_id" >
                    ...
                    foreach($room_list as $r){
                        ...
                        $selected = ($r->room_number==$employee_list_detail["room_id"])?" selected":"";
...
<script src="<?php echo base_url();?>assets/js/employee_list/employee_list_new.js"></script>
