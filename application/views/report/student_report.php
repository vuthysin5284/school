            ...
            <li class="default">
                <a href="<?php echo base_url();?>student_report/employee"
                   data-url="<?php echo base_url();?>student_report/employee" data-toggle="tab" aria-expanded="false">
                    <i class="fa fa-file-text-o"></i><?php echo get_phrase('sibling_report');?></a></li>
            <li class="default">
                <a href="<?php echo base_url();?>student_report/employee"
                   data-url="<?php echo base_url();?>student_report/employee" data-toggle="tab" aria-expanded="false">
                    <i class="fa fa-file-text-o"></i><?php echo get_phrase('parent_report');?></a></li>
            <li class="default">
                <a href="<?php echo base_url();?>student_report/employee"
                   data-url="<?php echo base_url();?>student_report/employee" data-toggle="tab" aria-expanded="false">
                    <i class="fa fa-file-text-o"></i><?php echo get_phrase('family_report');?></a></li>
        </ul>
    </div>
