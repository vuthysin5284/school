                    ...
                    <div class="row m-t-md">
                        ...
                        <div class="col-md-2">
                            <ul class="list-unstyled mailbox-nav">
                                <li class="active"><a href="<?php echo base_url();?>main/inbox"><i class="fa fa-inbox"></i>Inbox <span class="badge badge-success pull-right">4</span></a></li>
        ...
        <script src="<?php echo base_url();?>assets/js/pages/inbox.js"></script>
