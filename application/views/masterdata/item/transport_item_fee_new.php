...
<div class="modal-header">
    ...
    <h4 class="modal-title"><?php echo get_phrase($crud.'_transport_item_fee');?></h4>
</div>
...
<div class="panel-body">
    <?php echo form_open(base_url(),array('class' => 'form-horizontal form-groups-bordered',
        'id'=>'frmTransportItemFee', 'enctype' => 'multipart/form-data'));?>
...
<script src="<?php echo base_url();?>assets/js/master_data/transport_item_new_new.js"></script>