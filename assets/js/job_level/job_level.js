// JavaScript Document
var datable_result;
var _url_path =  baseurl+'job_level/new_job_level/';
var _url_del =  baseurl+'job_level/delete/';

$(document).ready(function() {
    datable_result = $('#datable_job_level').DataTable( {
        "filter"		: true,
        "info"			: true,
        "paging"		: true,
        "ordering"		: true,
        ...
        "ajax"       : {
            "url"    : baseurl+'job_level/get_job_level_data',
            "type"   : 'POST',
            "destroy" : true
        },
        language: {
