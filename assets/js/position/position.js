// JavaScript Document
var datable_result;
var _url_path =  baseurl+'position/new_position/';
var _url_del =  baseurl+'position/delete/';

$(document).ready(function() {
    datable_result = $('#datable_position').DataTable( {
        "filter"		: true,
        "info"			: true,
        "paging"		: true,
        "ordering"		: true,
        ...
        "ajax"       : {
            "url"    : baseurl+'position/get_position_data',
            "type"   : 'POST',
            "destroy" : true
        },
        language: {
