// JavaScript Document
var datable_result;
var _url_path =  baseurl+'main_station/new_main_station/';
var _url_del =  baseurl+'main_station/delete/';

$(document).ready(function() {
    datable_result = $('#datable_main_station').DataTable( {
        "filter"		: true,
        "info"			: true,
        "paging"		: true,
        "ordering"		: true,
        ...
        "ajax"       : {
            "url"    : baseurl+'main_station/get_main_station_data',
            "type"   : 'POST',
            "destroy" : true
        },
        language: {
