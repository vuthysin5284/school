// JavaScript Document
var datable_result;
var _url_path =  baseurl+'position_status/new_position_status/';
var _url_del =  baseurl+'position_status/delete/';

$(document).ready(function() {
    datable_result = $('#datable_position_status').DataTable( {
        "filter"		: true,
        "info"			: true,
        "paging"		: true,
        "ordering"		: true,
        ...
        "ajax"       : {
            "url"    : baseurl+'position_status/get_position_status_data',
            "type"   : 'POST',
            "destroy" : true
        },
        language: {
