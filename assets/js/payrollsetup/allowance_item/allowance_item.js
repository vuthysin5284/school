// JavaScript Document
var datable_result;
var _url_path =  baseurl+'allowance_item/new_allowance_item/';
var _url_del =  baseurl+'allowance_item/delete/';

$(document).ready(function() {
    datable_result = $('#datable_allowance_item').DataTable( {
        "filter"		: true,
        "info"			: true,
        "paging"		: true,
        "ordering"		: true,
        ...
        "ajax"       : {
            "url"    : baseurl+'allowance_item/allowance_item_data',
            "type"   : 'POST',
            "destroy" : true
        },
        language: {
