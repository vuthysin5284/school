// JavaScript Document
var datable_result;
var _url_path =  baseurl+'department/new_department/';
var _url_del =  baseurl+'department/delete/';

$(document).ready(function() {
    datable_result = $('#datable_department').DataTable( {
        "filter"		: true,
        "info"			: true,
        "paging"		: true,
        "ordering"		: true,
        ...
        "ajax"       : {
            "url"    : baseurl+'department/get_department_data',
            "type"   : 'POST',
            "destroy" : true
        },
        language: {
