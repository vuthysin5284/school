...
var _url_edit = baseurl+'student/enrolment_detail_info/';
        ...
        "columns"    : [
            ...
            { "data" : "id",
                "fnCreatedCell"	: function (nTd, sData, oData, iRow, iCol) {
                    $(nTd).html(
                        '<center>'+                                             
                        '<a href="javascript:void(0);" class="label label-info" onclick="edit_enrolment_data(\''+_url_edit+'\');"><i class="fa fa-pencil-square-o"></i></a>&nbsp;|&nbsp;'+
